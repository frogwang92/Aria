...
public:
   ...
   virtual double normalize_buy_shares(double request_cash, double request_price);
   virtual double normalize_sell_shares(double available_shares, double percentage);
};
